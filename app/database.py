...
def init_schema(conn: sqlite3.Connection) -> None:
    conn.executescript("""
        ...
        CREATE TABLE IF NOT EXISTS foods (
            ...
            butyric_acid_g REAL,
            caproic_acid_g REAL,
            caprylic_acid_g REAL,
            capric_acid_g REAL,
            lauric_acid_g REAL,
            myristic_acid_g REAL,
            pentadecylic_acid_g REAL,
            palmitic_acid_g REAL,
            margaric_acid_g REAL,
            stearic_acid_g REAL,
            arachidic_acid_g REAL,
            behenic_acid_g REAL,
            lignoceric_acid_g REAL,
            myristoleic_acid_g REAL,
            pentadecenoic_acid_g REAL,
            palmitoleic_acid_g REAL,
            sapienic_acid_g REAL,
            heptadecenoic_acid_g REAL,
            oleic_acid_g REAL,
            oleic_acid_cis_g REAL,
            gondoic_acid_g REAL,
            docosenoic_acid_g REAL,
            erucic_acid_g REAL,
            nervonic_acid_g REAL,
            pufa_18_2_g REAL,
            conjugated_linoleic_acid_g REAL,
            pufa_18_3_g REAL,
            gamma_linolenic_acid_g REAL,
            pufa_18_3i_g REAL,
            stearidonic_acid_g REAL,
            eicosadienoic_acid_g REAL,
            pufa_20_3_g REAL,
            eicosatrienoic_acid_g REAL,
            dihomo_gamma_linolenic_acid_g REAL,
            adrenic_acid_g REAL,
            dpa_g REAL,
            trans_monoenoic_fat_g REAL,
            trans_palmitoleic_acid_g REAL,
            trans_oleic_acid_g REAL,
            trans_erucic_acid_g REAL,
            trans_linoleic_acid_g REAL,
            trans_polyenoic_fat_g REAL,
            fiber_g REAL,
