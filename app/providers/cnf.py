...
FIELD_NUTRIENTS: dict[str, tuple[str, ...]] = {
    ...
    "vitamin_d2_ug": ("325",),
    "vitamin_d3_ug": ("326",),
    "vitamin_d3_25_hydroxy_ug": ("327",),
    "vitamin_e_mg": ("323",),
    "beta_tocopherol_mg": ("341",),
    "gamma_tocopherol_mg": ("342",),
    "delta_tocopherol_mg": ("343",),
    "alpha_tocotrienol_mg": ("344",),
    "beta_tocotrienol_mg": ("345",),
    "gamma_tocotrienol_mg": ("346",),
    "delta_tocotrienol_mg": ("347",),
    "vitamin_k_ug": ("430",),
    "dihydrophylloquinone_ug": ("429",),
    "menaquinone_4_ug": ("428",),
    "thiamin_mg": ("404",),
    "riboflavin_mg": ("405",),
    "niacin_mg": ("406",),
    "vitamin_b6_mg": ("415",),
    ...
    "folate_food_ug": ("432",),
    "folate_dfe_ug": ("435",),
    "folate_5_mthf_ug": ("433",),
    "folate_10_formyl_ug": ("436",),
    "folate_5_formyl_ug": ("437",),
    "vitamin_b12_added_ug": ("578",),
    "pantothenic_acid_mg": ("410",),
    "biotin_ug": ("416",),
    "vitamin_c_mg": ("401",),
    "choline_mg": ("421",),
    "choline_free_mg": ("450",),
    "choline_phosphocholine_mg": ("451",),
    "choline_phosphatidylcholine_mg": ("452",),
    "choline_glycerophosphocholine_mg": ("453",),
    "choline_sphingomyelin_mg": ("455",),
    "caffeine_mg": ("262",),
    "alanine_g": ("513",),
    "arginine_g": ("511",),
    "aspartic_acid_g": ("514",),
